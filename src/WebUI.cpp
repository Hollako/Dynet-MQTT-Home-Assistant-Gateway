    ...
    "(function(){"
      ...
      ".then(function(d){"
        ...
        "if(asset){"
          ...
          "if(_esp32&&isNewer)html+=' <button id=\"instBtn\" class=\"btn\" style=\"font-size:13px\" data-u=\"'+asset.browser_download_url+'\" data-t=\"'+tag+'\" onclick=\"_inst(this.dataset.u,this.dataset.t)\">&#8659; Download &amp; Upgrade</button>';"
        ...
        "st.innerHTML=isNewer"
          "?(_esp32"
            "?\"<span style='color:#f59e0b;font-weight:600;font-size:15px'>&#9650; New version available &mdash; click <b>Download latest .bin</b> to flash manually, or click <b>Download &amp; Upgrade</b> to upgrade automatically</span>\""
            ":\"<span style='color:#f59e0b;font-weight:600;font-size:15px'>&#9650; New version available &mdash; click <b>Download latest .bin</b> to get the firmware, then choose the file and click <b>Flash</b></span>\")"
